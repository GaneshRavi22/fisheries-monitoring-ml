...
public class FishClassifier {
    private static final Logger log = LoggerFactory.getLogger(FishClassifier.class);

    public static void main(String[] args) throws Exception {
        int nChannels = 3; // Number of input channels
        int outputNum = 8; // The number of possible outcomes
        ...
        MultiLayerConfiguration.Builder builder = new NeuralNetConfiguration.Builder()
                ...
                .layer(5, new OutputLayer.Builder(LossFunctions.LossFunction.NEGATIVELOGLIKELIHOOD)
                        ...
                        .activation("softmax")
                        .build())
                .setInputType(InputType.convolutionalFlat(760,1280,3)) //See note below
